...
```{r shapes, echo=FALSE, fig.cap="Different shapes that can be used for plotting."}
...
```{r boxplots, echo=FALSE, fig.cap="Box plot distributions. Source: https://www.autodeskresearch.com/publications/samestats"}
...
```{r boxplot-violin, echo=FALSE, fig.cap="Boxplot distributions. Source: https://www.autodeskresearch.com/publications/samestats"}
...
```{r interval=1/60, results='hold', cache=TRUE}
