...
Let's install the new packages that you might not have yet. 

```{r, eval=FALSE}
install.packages(c("ggpol", "gganimate","gapminder", "ggridges", "devtools"))
...
```{r}
set.seed(1)
data = data.frame(rating = sample(x = 1:7, prob = c(0.1, 0.4, 0.1, 0.1, 0.2, 0, 0.1), size = 100, replace = T))
