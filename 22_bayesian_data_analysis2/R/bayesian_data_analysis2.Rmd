...
plot(fit.brm_wrong,
     ...
     ask = F)
```
The chain plots do not look like fuzzt caterpillers. 
...
animate(p, width = 800, height = 600, res = 96, type = "cairo")
```
...
fit.brm_poker_prior = brm(formula = balance ~ 0 + Intercept + hand * skill,
                          ...
                          sample_prior = "only", #only drawing from prior
                          seed = 1)
...
- [Learn stan with brms (part 1)](https://solomonkurz.netlify.app/blog/2025-07-07-learn-stan-with-brms-part-i/), [Learn stan with brms (part 2)](https://solomonkurz.netlify.app/blog/2025-07-13-learn-stan-with-brms-part-ii/) 
