...
```{r simulation1-22, fig.cap='Density estimation.'}
...
df.quantile_values = tibble(median = quantile(df.quantile$value, 0.5),
                            ...
                            whisker_lower = quartile_first - 1.5 * iqr)
...
```{r simulation1-34, fig.cap="Empirical distribution of residuals, and theoretical distribution."}
...
```{r simulation1-35, fig.cap="Quantile-Quantile plot."}
...
```{r simulation1-36, message=FALSE, warning=FALSE}
...
```{r simulation1-37, warning=FALSE}
...
```{r simulation1-38, echo=FALSE, out.width='90%', fig.cap="QQ plots indicating different deviations from normality."}
include_graphics("figures/qqplots.png")
```

## Relationship between probability and likelihood 

```{r simulation1-39, fig.cap="Probability is the area under the curve of the density"}
...
```{r simulation1-40, fig.cap="Likelihood is a particular value."}
point = 0
param_mean = 1
param_sd = 1
...
```{r simulation1-41, fig.cap="Relationship between density and cumulative probability distribution."}
...
```{r simulation1-42, fig.cap="The density is the first derivative of the cumulative probability distribution. The likelihood is the value of the slope in the cumulative probability distribution."}
...
```{r simulation1-43, fig.cap="The relative likelihood of two observations is the same as the relative probability of two areas under the curve as the margin of these areas goes to 0."}
margin = 0.1
point_blue = -1
point_red = 0
