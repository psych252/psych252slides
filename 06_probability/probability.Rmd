...
```{r probability-04, echo=FALSE, fig.cap="Drawing two marbles out of an urn __with__ replacement."}
grViz("
digraph dot{
...
```{r probability-05, echo=FALSE, fig.cap="Drawing two marbles out of an urn __without__ replacement."}
grViz("
digraph dot{
...
```{r probability-06, fig.cap='A demonstration of the law of large numbers.'}
...
A secretary types four letters to four people and addresses the four envelopes. If he inserts the letters at random, each in a different envelope, what is the probability that exactly three letters will go into the right envelope? [Gardner, p. 39].

```{r}
df.letters = permutations(x = 1:4, n = 4) %>% 
  as_tibble(.name_repair = "minimal") %>% 
  set_names(str_c("person_", 1:4)) %>% 
