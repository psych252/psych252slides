...
Before we get started, let's make a few changes to RStudio's default settings. 
...
Take a look [here](https://ggplot2.tidyverse.org/reference/#section-layer-geoms) to see what other geoms ggplot2 supports.
```
...
```{r practice-plot3, out.width="90%", fig.align="center"}
...
```{r practice-plot4, out.width="90%", fig.align="center"}
