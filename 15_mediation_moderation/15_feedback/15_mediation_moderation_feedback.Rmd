...
- Try to cover mediation and moderation before the midterm next time (or don't ask for controlling in the midterm).
- Try to make the idea of controlling for variables more clear by using a concrete example. 
- Encourage questions, and cover less. 
